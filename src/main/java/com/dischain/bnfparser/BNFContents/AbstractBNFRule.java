 ...
 * символу <code>"="</code>
 * <p>Правило грамматики определяется <i>выражением</i>
 * <code>AbstractBNFExpression</code>, стоящим в его правой части и
 ...
 * два типа классов:
 * <p><code>NonterminalBNFRule</code> - представляет правило, описывающее множество
 * нетерминальных выражений, т.е. выражений, сотоящих только из нетерминвльных
 * символов.
 * <p><code>TerminalBNFRule</code> - представляет правило, описывающее множество
